...
public enum Ability {
    ...
    STRENGTH("Strength is ability mostly used by warriors. One point of Strength also increase you " + Constant.HEALTH_PER_POINT_OF_STRENGTH + " points of Health."),
    INTELLECT("Intellect is important mostly by mages. One point of Intellect also increase you " + Constant.MANA_PER_POINT_OF_INTELLECT + " points of Mana."),
