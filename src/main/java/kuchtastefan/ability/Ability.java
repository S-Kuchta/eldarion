...
@Getter
public enum Ability {
    ATTACK("Attack is the ability to deal damage. Every 5 points of attack increase you 1 point of critical hit chance. Final damage can be also affected by primary ability."),
