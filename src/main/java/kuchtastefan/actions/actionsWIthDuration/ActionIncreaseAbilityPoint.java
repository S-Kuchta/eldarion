...
//        gameCharacter.getCurrentAbilities().put(this.ability, gameCharacter.getCurrentAbilityValue(this.ability) + (increaseAbilityWithStacks));
        gameCharacter.increaseAbilityValue(this.ability, increaseAbilityWithStacks);
