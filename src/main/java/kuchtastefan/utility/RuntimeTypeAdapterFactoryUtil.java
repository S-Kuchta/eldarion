...
//            .enableComplexMapKeySerialization().setPrettyPrinting().create();
    ...
    public static final RuntimeTypeAdapterFactory<Action> actionsRuntimeTypeAdapterFactory = RuntimeTypeAdapterFactory
            ...
            .registerSubtype(ActionRestoreHealthPrimary.class)
            .registerSubtype(ActionDealDamagePrimary.class)
            .registerSubtype(ActionDealDamageOverTimePrimary.class)
            .registerSubtype(ActionRestoreHealthOverTimePrimary.class)
            .registerSubtype(ActionIncreaseAbilityPoint.class)
            .registerSubtype(ActionAbsorbDamagePrimary.class)
            .registerSubtype(ActionRestoreManaPrimary.class)
            .registerSubtype(ActionRestoreManaOverTimePrimary.class)
            ...
            .registerSubtype(ActionDrainManaPrimary.class)
